...
def main():
    ...
    print("----------------------------------------------------------------------------------")
    print("Testing: Mean if condition")
    print("----------------------------------------------------------------------------------")
    result = stata.mean(['age_squared'])
    print(result[1])
    result = stata.mean(['age_squared'], 'age_squared > 500')
    print(result[1])

    print("----------------------------------------------------------------------------------")
    print("Testing: Summarize if condition")
    print("----------------------------------------------------------------------------------")
    result = stata.summarize(['age_squared'])
    print("Result:", result[1])

    result = stata.summarize(['age_squared'], 'age_squared > 500')
    print("Result:", result[1])
